...
{
    public partial class Form_ProductosReporte : Form
    {
        private void mtdGrafica2()
        {
            ...
            {
                chart1.Series[0].Points.AddXY(item[1].ToString(), item[2].ToString());
            }
        }
        public Form_ProductosReporte()
        {
            InitializeComponent();
        }
        ...
        private void BtnMensual_Click(object sender, EventArgs e)
        {
            ...
            mensual = objN.MtdProductoMensuales();
        ...
        private void BtnTrimestral_Click(object sender, EventArgs e)
        {
            ...
            Cls_N_Reportes objN = new Cls_N_Reportes();
            mensual = objN.MtdProductotrimestral();
            dgConsultas.DataSource = mensual;
            mtdGrafica2();
        }
        ...
        private void BtnSemestral_Click(object sender, EventArgs e)
        {
            ...
            Cls_N_Reportes objN = new Cls_N_Reportes();
            mensual = objN.MtdProductoSemestral();
            dgConsultas.DataSource = mensual;
            mtdGrafica2();
